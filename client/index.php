...
?>
<div style='font-size: 25px; font-weight: bold; text-align: center;' id='servertitle'>Chat</div>
<div id='messages' style='height: 66vh; overflow: auto; border-top: 1px solid black; border-bottom: 1px solid black;'>
</div>
<center>

<!-- Username -->
<?php echo gettext('Username:') ?> <input type="text" id="name" style="width: 20vw" class="textInput" value='<?php if (isset($_GET['name'])) { echo $_GET['name']; } ?>'>
...
<div id='Emoji' class='tabcontent'>
 <form action='../server/insert.php' method='get' style='margin-left: 1px; margin-right: 1px;' id='emojiForm'>
  <span class='elementBox'><label><input type='radio' name='content' value='smile.png' checked><img src='../emojis/smile.png' width='50px' height='50px' /></label></span>
  <span class='elementBox'><label><input type='radio' name='content' value='sad.png'><img src='../emojis/sad.png' width='50px' height='50px' /></label></span>
  <span class='elementBox'><label><input type='radio' name='content' value='simple-emoticon-4.png'><img src='../emojis/simple-emoticon-4.png' width='50px' height='50px' /></label></span>
  <span class='elementBox'><label><input type='radio' name='content' value='question-face.png'><img src='../emojis/question-face.png' width='50px' height='50px' /></label></span>
  <span class='elementBox'><label><input type='radio' name='content' value='unknown-smiley.png'><img src='../emojis/unknown-smiley.png' width='50px' height='50px' /></label></span>
  <span class='elementBox'><label><input type='radio' name='content' value='cry-smiley.png'><img src='../emojis/cry-smiley.png' width='50px' height='50px' /></label></span>
  <span class='elementBox'><label><input type='radio' name='content' value='heart.png'><img src='../emojis/heart.png' width='50px' height='50px' /></label></span><br>
...
<!-- Bottom text -->
<div style='text-align: right; font-size: 12px;'><a href='about.html' style='color: black;'><?php echo gettext('Powered by BSChat (by bartbart2003) - About') ?></a></div>
